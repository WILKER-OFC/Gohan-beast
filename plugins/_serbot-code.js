...
✩ Escanea este QR para ser *Sub-Bot* temporal de Gohan beast bot*.  
✦ Pasos:  
1️⃣ » Toca ⋮ arriba a la derecha  
2️⃣ » Ve a *Dispositivos vinculados* 3 » Escanea el QR  

✧ Este código expira en *45s*!`

let rtx2 = `❐ *_Vincula via código de 8 digitos_*
✩ Usa este código para ser *Sub-Bot*  *temporal de Gohan beast bot*.  
✦ Pasos:  
1️⃣ » Toca ⋮ arriba a la derecha  
2️⃣ » *Dispositivos vinculados* 3 » 3️⃣Vincular con el *número de teléfono* 4 4️⃣ » Escribe el *código*`
